item_moo_axe_modifier = class({})

--------------------------------------------------------------------------------
-- Classifications
function item_moo_axe_modifier:IsHidden()
	return true
end

function item_moo_axe_modifier:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function item_moo_axe_modifier:OnCreated( kv )
	-- references
...
function item_moo_axe_modifier:OnRefresh( kv )
	-- references
	self:OnCreated( kv )
end

function item_moo_axe_modifier:OnDestroy( kv )

end

--------------------------------------------------------------------------------
-- Modifier Effects
function item_moo_axe_modifier:DeclareFunctions()
	local funcs = {
...
function item_moo_axe_modifier:GetModifierBonusStats_Strength( params )
	return self.all_stats
end

function item_moo_axe_modifier:GetModifierBonusStats_Agility( params )
	return self.all_stats
end

function item_moo_axe_modifier:GetModifierBonusStats_Intellect( params )
	return self.all_stats
end

function item_moo_axe_modifier:GetModifierProcAttack_BonusDamage_Physical( params )
	if IsServer() then
...
function item_moo_axe_modifier:GetModifierProcAttack_Feedback( params )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Helper
function item_moo_axe_modifier:RollChance( chance )
