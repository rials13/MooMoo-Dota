--------------------------------------------------------------------------------
modifier_moomoo_reactive_armor_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_moomoo_reactive_armor_lua:IsHidden()
	return self:GetStackCount()==0
end

function modifier_moomoo_reactive_armor_lua:IsDebuff()
	return false
end

function modifier_moomoo_reactive_armor_lua:IsStunDebuff()
	return false
end

function modifier_moomoo_reactive_armor_lua:IsPurgable()
	return false
end

function modifier_moomoo_reactive_armor_lua:DestroyOnExpire()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_moomoo_reactive_armor_lua:OnCreated( kv )
	-- references
...
function modifier_moomoo_reactive_armor_lua:OnRefresh( kv )
	-- references
	self.stack_duration = self:GetAbility():GetSpecialValueFor( "stack_duration" )
	self.stack_limit = self:GetAbility():GetSpecialValueFor( "stack_limit" )
	self.stack_regen = self:GetAbility():GetSpecialValueFor( "bonus_hp_regen" )
...
function modifier_moomoo_reactive_armor_lua:OnRemoved()
end

function modifier_moomoo_reactive_armor_lua:OnDestroy()
end
