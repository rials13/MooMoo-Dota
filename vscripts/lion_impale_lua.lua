lion_impale_lua = class({})
LinkLuaModifier( "modifier_generic_stunned_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_generic_knockback_lua", LUA_MODIFIER_MOTION_BOTH )

--------------------------------------------------------------------------------
-- Ability Start
function lion_impale_lua:OnSpellStart()
	-- unit identifier
	...
	local projectile_distance = self:GetCastRange( point, target ) + self:GetSpecialValueFor( "length_buffer" )
...
--------------------------------------------------------------------------------
-- Projectile
function lion_impale_lua:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function lion_impale_lua:PlayEffects( target )
	-- Get Resources
