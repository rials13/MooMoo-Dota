modifier_lion_gun_flare_lua_thinker = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_lion_gun_flare_lua_thinker:IsHidden()
	return true
end

function modifier_lion_gun_flare_lua_thinker:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_lion_gun_flare_lua_thinker:OnCreated( kv )
...
function modifier_lion_gun_flare_lua_thinker:OnRefresh( kv )
	
end

function modifier_lion_gun_flare_lua_thinker:OnRemoved()
end

function modifier_lion_gun_flare_lua_thinker:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_lion_gun_flare_lua_thinker:OnIntervalThink()
	...
	for _,enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(
			...
			"modifier_lion_gun_flare_lua", -- modifier name
			{
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_lion_gun_flare_lua_thinker:PlayEffects()
	-- Get Resources
